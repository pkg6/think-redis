 ...
 * @method static null hget($key, $field)
 ...
 * @method static null blpop(array|string $keys, $timeout)
 * @method static null brpop(array|string $keys, $timeout)
 ...
 * @method static null spop($key, $count = null)
